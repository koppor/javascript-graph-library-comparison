! function t(e, r) {
  "object" == typeof exports && "object" == typeof module ? module.exports = r(require("eve")) : "function" == typeof define && define.amd ? define(["eve"], r) : "object" == typeof exports ? exports.Raphael = r(require("eve")) : e.Raphael = r(e.eve)
}(this, function(t) {
  return function(t) {
    function e(i) {
    ...
    i = [r(2)], n = function(t) {
      ...
      function p(t, r, i) {
        ...
        for (var s = l.apply(0, t), o = l.apply(0, r), h = Y(~~(s / 5), 1), c = Y(~~(o / 5), 1), f = [], p = [], d = {}, g = i ? 0 : [], x = 0; x < h + 1; x++) {
        ...
        for (x = 0; x < c + 1; x++) v = e.findDotsAtSegment.apply(e, r.concat(x / c)), p.push({
          x: v.x,
          y: v.y,
          t: x / c
        });
        for (x = 0; x < h; x++)
          for (var y = 0; y < c; y++) {
            ...
            if (C) {
              ...
              S >= 0 && S <= 1.001 && T >= 0 && T <= 1.001 && (i ? g++ : g.push({
                x: C.x,
                y: C.y,
                t1: G(S, 1),
                t2: G(T, 1)
            ...
            for (var m = 0, b = r.length; m < b; m++) {
              ...
              if ("M" == _[0]) s = u = _[1], o = c = _[2];
                ...
                if (i) g += w;
                  ...
                  for (var k = 0, B = w.length; k < B; k++) w[k].segment1 = x, w[k].segment2 = m, w[k].bez1 = f, w[k].bez2 = d;
                  g = g.concat(w)
                }
              }
            }
        ...
        if (l) {
          if (h) h.initstatus = a, h.start = new Date - h.ms * a;
              ...
              if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C))) switch (v[C] = i.attr(C), null == v[C] && (v[C] = ft[C]), m[C] = l[C], pt[C]) {
                ...
                case "transform":
                  var L = i._,
                    F = le(L[C], m[C]);
                  if (F)
                    for (v[C] = F.from, m[C] = F.to, b[C] = [], b[C].real = !0, w = 0, B = v[C].length; w < B; w++)
                      for (b[C][w] = [v[C][w][0]], N = 1, E = v[C][w].length; N < E; N++) b[C][w][N] = (m[C][w][N] - v[C][w][N]) / x;
                  else {
            ...
            if (d = l.start || r.start || +new Date, _ = {
                ...
                origin: i.attr(),
                totalOrigin: s
              }, Me.push(_), a && !h && !u && (_.stop = !0, _.start = new Date - x * a, 1 == Me.length)) return Ee();
      ...
      var w, k = /[, ]+/,
        ...
        q = String,
        I = "split",
        D = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel" [I](j),
        V = {
      ...
      if (e._g = A, e.type = A.win.SVGAngle || A.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML", "VML" == e.type) {
        var Et = A.doc.createElement("div"),
          Lt;
        if (Et.innerHTML = '<v:shape adj="1"/>', Lt = Et.firstChild, Lt.style.behavior = "url(#default#VML)", !Lt || "object" != typeof Lt.adj) return e.type = R;
        Et = null
      }
      e.svg = !(e.vml = "VML" == e.type), e._Paper = N, e.fn = E = N.prototype = e.prototype, e._id = 0, e.is = function(t, e) {
      ...
      e.color = function(t) {
        ...
        var n, a, s, o, l;
        return t = t % 360 / 60, l = 2 * e * (r < .5 ? r : 1 - r), o = l * (1 - H(t % 2 - 1)), n = a = s = r - l / 2, t = ~~t, n += [l, o, 0, 0, o, l][t], a += [o, l, l, o, 0, 0][t], s += [0, 0, o, l, l, o][t], It(n, a, s, i)
        ...
        r = qt(t, e, r), t = r[0], e = r[1], r = r[2];
        var i, n, a, s, o, l;
        return s = Y(t, e, r), o = G(t, e, r), l = s - o, i = 0 == l ? null : s == t ? (e - r) / l : s == e ? (r - t) / l + 2 : (t - e) / l + 4, i = (i + 360) % 6 * 60 / 360, a = (s + o) / 2, n = 0 == l ? 0 : a < .5 ? l / (2 * a) : l / (2 - 2 * a), {
          h: i,
          s: n,
          l: a,
          toString: Rt
      ...
      var Ot = e.pathBBox = function(t) {
          ...
          for (var u = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), c, f, p = h, d = t.length; p < d; p++) {
            if (i.push(c = []), f = t[p], f[0] != ct.call(f[0])) switch (c[0] = ct.call(f[0]), c[0]) {
                ...
                case "H":
                  ...
                  break;
                case "R":
                  for (var g = [n, a][P](f.slice(1)), x = 2, v = g.length; x < v; x++) g[x] = +g[x] + n, g[++x] = +g[x] + a;
                  i.pop(), i = i[P](s(g, u));
                  break;
                case "M":
                  o = +f[1] + n, l = +f[2] + a;
        ...
        Ut = function(t, e, r, i, a, s, o, l, h, u) {
          ...
          if (u) S = u[0], T = u[1], B = u[2], C = u[3];
            ...
            S = t < B ? U - S : S, T = l < B ? U - T : T, S < 0 && (S = 2 * U + S), T < 0 && (T = 2 * U + T), o && S > T && (S -= 2 * U), !o && T > S && (T -= 2 * U)
          }
          var A = T - S;
          if (H(A) > c) {
            var M = T,
              N = l,
              E = h;
            T = S + c * (o && T > S ? 1 : -1), l = B + r * W.cos(T), h = C + i * W.sin(T), p = Ut(l, h, r, i, a, 0, o, N, E, [T, M, B, C])
          }
          A = T - S;
          var L = W.cos(S),
            F = W.sin(S),
        ...
        Qt = e._path2curve = n(function(t, e) {
          ...
          for (var i = Gt(t), n = e && Gt(e), a = {
            ...
            }, u = [], c = [], f = "", p = "", d = 0, g = Y(i.length, n && n.length || 0); d < g; d++) {
        ...
        le = e._equaliseTransform = function(t, r) {
          ...
          for (var i = Y(t.length, r.length), n = [], a = [], s = 0, o, l, h, u; s < i; s++) {
            ...
            for (n[s] = [], a[s] = [], o = 0, l = Y(h.length, u.length); o < l; o++) o in h && (n[s][o] = h[o]), o in u && (a[s][o] = u[o])
          }
          return {
            from: n,
            to: a
      ...
      e._getContainer = function(t, r, i, n) {
          var a;
          if (a = null != n || e.is(t, "object") ? t : A.doc.getElementById(t), null != a) return a.tagName ? null == r ? {
            container: a,
        ...
        function(t) {
          ...
          t.add = function(t, e, r, i, n, a) {
            ...
            var a = -n[0][1],
              s = n[1][1];
            return s < 0 ? (t.rotate = e.deg(W.acos(s)), a < 0 && (t.rotate = 360 - t.rotate)) : t.rotate = e.deg(W.asin(a)), t.isSimple = !(+t.shear.toFixed(9) || t.scalex.toFixed(9) != t.scaley.toFixed(9) && t.rotate), t.isSuperSimple = !+t.shear.toFixed(9) && t.scalex.toFixed(9) == t.scaley.toFixed(9) && !t.rotate, t.noRotation = !+t.shear.toFixed(9) && !t.rotate, t
      ...
      }, E.top = E.bottom = null, E.raphael = e;
      var _e = function(t) {
      ...
      E.getElementByPoint = function(t, e) {
        ...
        var e = this._;
        return t ? (!e.dirty && e.bboxwt || (this.realPath = Mt[this.type](this), e.bboxwt = Ot(this.realPath), e.bboxwt.toString = v, e.dirty = 0), e.bboxwt) : ((e.dirty || e.dirtyT || !e.bbox) && (!e.dirty && this.realPath || (e.bboxwt = 0, this.realPath = Mt[this.type](this)), e.bbox = Ot(Nt(this.realPath, this.matrix)), e.bbox.toString = v, e.dirty = e.dirtyT = 0), e.bbox)
      }, ye.clone = function() {
          ...
          for (var r = +new Date, i = 0; i < Me.length; i++) {
            ...
            if (!n.el.removed && !n.paused) {
              var a = r - n.start,
                ...
                d, g = {},
                x;
              if (n.initstatus ? (a = (n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev) * s, n.status = n.initstatus, delete n.initstatus, n.stop && Me.splice(i--, 1)) : n.status = (n.prev + (n.percent - n.prev) * (a / s)) / n.anim.top, !(a < 0))
                if (a < s) {
                  var v = o(a / s);
                  for (var y in l)
                    if (l[T](y)) {
                      switch (pt[y]) {
                        ...
                        case "path":
                          ...
                          for (var m = 0, _ = l[y].length; m < _; m++) {
                            d[m] = [l[y][m][0]];
                            for (var w = 1, k = l[y][m].length; w < k; w++) d[m][w] = +l[y][m][w] + v * s * h[y][m][w];
                            d[m] = d[m].join(j)
                          }
                          d = d.join(j);
                          break;
                        case "transform":
                          if (h[y].real)
                            for (d = [], m = 0, _ = l[y].length; m < _; m++)
                              for (d[m] = [l[y][m][0]], w = 1, k = l[y][m].length; w < k; w++) d[m][w] = l[y][m][w] + v * s * h[y][m][w];
                          else {
                            var B = function(t) {
                  ...
                  if (function(r, i, n) {
                    ...
                    }(n.callback, f, n.anim), f.attr(u), Me.splice(i--, 1), n.repeat > 1 && !n.next) {
      ...
      ye.animateWith = function(t, r, i, n, a, s) {
        ...
        for (var r = 0; r < Me.length; r++) Me[r].el.id != this.id || e && Me[r].anim != e || t("raphael.anim.pause." + this.id, this, Me[r].anim) !== !1 && (Me[r].paused = !0);
        return this
        ...
        for (var r = 0; r < Me.length; r++) Me[r].el.id != this.id || e && Me[r].anim != e || t("raphael.anim.stop." + this.id, this, Me[r].anim) !== !1 && Me.splice(r--, 1);
        return this
      ...
      var Fe = function(t) {
          if (this.items = [], this.length = 0, this.type = "set", t)
            for (var e = 0, r = t.length; e < r; e++) !t[e] || t[e].constructor != ye.constructor && t[e].constructor != Fe || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++)
        },
        Pe = Fe.prototype;
      Pe.push = function() {
        for (var t, e, r = 0, i = arguments.length; r < i; r++) t = arguments[r], !t || t.constructor != ye.constructor && t.constructor != Fe || (e = this.items.length, this[e] = this.items[e] = t, this.length++);
        return this
      }, Pe.pop = function() {
      ...
      return Pe.attr = function(t, r) {
          ...
          if (e.is(n, "string") && (n = this.getFont(n)), n) {
            ...
            for (var d = n.face.bbox[I](k), g = +d[0], x = d[3] - d[1], v = 0, y = +d[1] + ("baseline" == s ? x + +n.face.descent : x / 2), m = 0, b = h.length; m < b; m++) {
          ...
          if (e.is(t, "array"))
            for (var r = this.set(), i = 0, n = t.length, a; i < n; i++) a = t[i] || {}, B[T](a.type) && r.push(this[a.type]().attr(a));
          return r
    ...
    i = [r(1)], n = function(t) {
      if (!t || t.svg) {
        ...
        var x = function(i, n) {
          ...
          v = function(e, n) {
            ...
            if (!y) {
              ...
              if (u = u.replace(/[\(\)\s,\xb0#]/g, "_"), e.gradient && u != e.gradient.id && (g.defs.removeChild(e.gradient), delete e.gradient), !e.gradient) {
                ...
                for (var B = 0, C = k.length; B < C; B++) y.appendChild(x("stop", {
            ...
            if ("path" == i.type) {
              ...
              if ("open" == v ? (k += 2, B += 2, C += 2, b = 1, _ = a ? 4 : 1, w = {
                ...
                var A = t._g.doc.getElementById(T),
                  M;
                A ? (g[T]++, M = A.getElementsByTagName("use")[0]) : (A = x(x("marker"), {
                  id: T,
                  markerHeight: B,
                  markerWidth: k,
                  orient: "auto",
                ...
                }), A.appendChild(M), o.defs.appendChild(A), g[T] = 1), x(M, w);
            ...
            for (var d in a)
              if (a[e](d)) {
                ...
                switch (u[d] = g, d) {
                  ...
                  case "stroke":
                    F = t.getRGB(g), l.setAttribute(d, F.hex), "stroke" == d && F[e]("opacity") && x(l, {
                  ...
                  case "fill-opacity":
                    if (u.gradient) {
                      P = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c)), P && (z = P.getElementsByTagName("stop"), x(z[z.length - 1], {
                        "stop-opacity": g
                      }));
                      break
                    }
          ...
          S = function(i, a) {
            if ("text" == i.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
              ...
              if (a[e]("text")) {
                ...
                for (var h = r(a.text).split("\n"), u = [], f, p = 0, d = h.length; p < d; p++) f = x("tspan"), p && x(f, {
                  dy: l * C,
                  x: s.x
                }), f.appendChild(t._g.doc.createTextNode(h[p])), o.appendChild(f), u[p] = f
              } else
                for (u = o.getElementsByTagName("tspan"), p = 0, d = u.length; p < d; p++) p ? x(u[p], {
                  dy: l * C,
                  x: s.x
                }) : x(u[0], {
                  dy: 0
          ...
          A = function(e, r) {
            ...
            var n = 0,
              a = 0;
            this[0] = this.node = e,
              e.raphael = !0, this.id = i(), e.raphaelid = this.id, this.matrix = t.matrix(), this.realPath = null, this.paper = r, this.attrs = this.attrs || {}, this._ = {
                transform: [],
                sx: 1,
                sy: 1,
                deg: 0,
          ...
          M = t.el;
        A.prototype = M, M.constructor = A, t._engine.path = function(t, e) {
          var r = x("path");
        ...
        var N = t.st;
        for (var E in M) M[e](E) && !N[e](E) && (N[E] = function(t) {
          return function() {
            var e = arguments;
            return this.forEach(function(r) {
              r[t].apply(r, e)
    ...
    i = [r(1)], n = function(t) {
      if (!t || t.vml) {
        var e = "hasOwnProperty",
          ...
          C = function(t, e, r, i, n, a) {
            ...
            if (f.visibility = "hidden", e && r) {
              ...
              if (e < 0 && (g += "x"), r < 0 && (g += " y") && (d = -1), f.flip = g, c.coordorigin = i * -v + p + n * -y, u || s.fillsize) {
        ...
        var S = function(t, e, i) {
          ...
          T = function(n, l) {
            ...
            if (v && (f.path = t._getPath[n.type](n), n._.dirty = 1), l.href && (c.href = l.href), l.title && (c.title = l.title), l.target && (c.target = l.target), l.cursor && (g.cursor = l.cursor), "blur" in l && n.blur(l.blur), (l.path && "path" == n.type || v) && (c.path = k(~r(f.path).toLowerCase().indexOf("r") ? t._pathToAbsolute(f.path) : f.path), n._.dirty = 1, "image" == n.type && (n._.fillpos = [f.x, f.y], n._.fillsize = [f.width, f.height], C(n, 1, 1, 0, 0, 0))), "transform" in l && n.transform(l.transform), y) {
              var T = +f.cx,
                ...
                N = +f.rx || +f.r || 0,
                L = +f.ry || +f.r || 0;
              c.path = t.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", a((T - N) * b), a((M - L) * b), a((T + N) * b), a((M + L) * b), a(T * b)), n._.dirty = 1
            }
            if ("clip-rect" in l) {
            ...
            if ("arrow-start" in l && S(m, l["arrow-start"]), "arrow-end" in l && S(m, l["arrow-end"], 1), null != l.opacity || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
              var j = c.getElementsByTagName(h),
                q = !1;
              if (j = j && j[0], !j && (q = j = E(h)), "image" == n.type && l.src && (j.src = l.src), l.fill && (j.on = !0), null != j.on && "none" != l.fill && null !== l.fill || (j.on = !1), j.on && l.fill) {
              ...
              var O = c.getElementsByTagName("stroke") && c.getElementsByTagName("stroke")[0],
                W = !1;
              !O && (W = O = E("stroke")), (l.stroke && "none" != l.stroke || l["stroke-width"] || null != l["stroke-opacity"] || l["stroke-dasharray"] || l["stroke-miterlimit"] || l["stroke-linejoin"] || l["stroke-linecap"]) && (O.on = !0), ("none" == l.stroke || null === l.stroke || null == O.on || 0 == l.stroke || 0 == l["stroke-width"]) && (O.on = !1);
          ...
          N = t.el;
        M.prototype = N, N.constructor = M, N.transform = function(e) {
        ...
        var L = t.st;
        for (var F in N) N[e](F) && !L[e](F) && (L[F] = function(t) {
          return function() {
            var e = arguments;
            return this.forEach(function(r) {
              r[t].apply(r, e)
